...
export const Tonggle = () => {
	...
	return (
		<label className="relative inline-flex items-center cursor-pointer self-center">
			...
			<div className="block h-8 w-14 rounded-full bg-cyan-400 dark:bg-cyan-100"></div>
			<div className="absolute top-0 left-0 h-8 w-8 rounded-full transition-transform transform peer-checked:translate-x-6 bg-cyan-200 dark:bg-cyan-900 flex items-center justify-center">
